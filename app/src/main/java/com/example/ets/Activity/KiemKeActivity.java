...
public class KiemKeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kiem_ke);
    ...
    private void setClickBtn(){
        ...
        add_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KiemKeActivity.this, KiemKe_AddActivity.class);
                intent.putExtra("resultKK", 0);
        ...
        p1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KiemKeActivity.this, KiemKe_CTActivity.class);
                intent.putExtra("resultKK", 0);
